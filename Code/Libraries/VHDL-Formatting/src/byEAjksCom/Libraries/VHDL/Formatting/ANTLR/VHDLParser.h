...
class VHDLParser : public antlr4::Parser
{
  public:
    ...
    enum
    {
        RuleAbstract_literal = 0,
        RuleAccess_type_definition = 1,
        RuleAcross_aspect = 2,
        RuleActual_designator = 3,
        RuleActual_parameter_part = 4,
        RuleActual_part = 5,
        RuleAdding_operator = 6,
        RuleAggregate = 7,
        RuleAlias_declaration = 8,
        RuleAlias_designator = 9,
        RuleAlias_indication = 10,
        RuleAllocator = 11,
        RuleArchitecture_body = 12,
        RuleArchitecture_declarative_part = 13,
        RuleArchitecture_statement = 14,
        RuleArchitecture_statement_part = 15,
        RuleArray_nature_definition = 16,
        RuleArray_type_definition = 17,
        RuleAssertion = 18,
        RuleAssertion_statement = 19,
        RuleAssociation_element = 20,
        RuleAssociation_list = 21,
        RuleAttribute_declaration = 22,
        RuleAttribute_designator = 23,
        RuleAttribute_specification = 24,
        RuleBase_unit_declaration = 25,
        RuleBinding_indication = 26,
        RuleBlock_configuration = 27,
        RuleBlock_declarative_item = 28,
        RuleBlock_declarative_part = 29,
        RuleBlock_header = 30,
        RuleBlock_specification = 31,
        RuleBlock_statement = 32,
        RuleBlock_statement_part = 33,
        RuleBranch_quantity_declaration = 34,
        RuleBreak_element = 35,
        RuleBreak_list = 36,
        RuleBreak_selector_clause = 37,
        RuleBreak_statement = 38,
        RuleCase_statement = 39,
        RuleCase_statement_alternative = 40,
        RuleChoice = 41,
        RuleChoices = 42,
        RuleComponent_configuration = 43,
        RuleComponent_declaration = 44,
        RuleComponent_instantiation_statement = 45,
        RuleComponent_specification = 46,
        RuleComposite_nature_definition = 47,
        RuleComposite_type_definition = 48,
        RuleConcurrent_assertion_statement = 49,
        RuleConcurrent_break_statement = 50,
        RuleConcurrent_procedure_call_statement = 51,
        RuleConcurrent_signal_assignment_statement = 52,
        RuleCondition = 53,
        RuleCondition_clause = 54,
        RuleConditional_signal_assignment = 55,
        RuleConditional_waveforms = 56,
        RuleConfiguration_declaration = 57,
        RuleConfiguration_declarative_item = 58,
        RuleConfiguration_declarative_part = 59,
        RuleConfiguration_item = 60,
        RuleConfiguration_specification = 61,
        RuleConstant_declaration = 62,
        RuleConstrained_array_definition = 63,
        RuleConstrained_nature_definition = 64,
        RuleConstraint = 65,
        RuleContext_clause = 66,
        RuleContext_item = 67,
        RuleDelay_mechanism = 68,
        RuleDesign_file = 69,
        RuleDesign_unit = 70,
        RuleDesignator = 71,
        RuleDirection = 72,
        RuleDisconnection_specification = 73,
        RuleDiscrete_range = 74,
        RuleElement_association = 75,
        RuleElement_declaration = 76,
        RuleElement_subnature_definition = 77,
        RuleElement_subtype_definition = 78,
        RuleEntity_aspect = 79,
        RuleEntity_class = 80,
        RuleEntity_class_entry = 81,
        RuleEntity_class_entry_list = 82,
        RuleEntity_declaration = 83,
        RuleEntity_declarative_item = 84,
        RuleEntity_declarative_part = 85,
        RuleEntity_designator = 86,
        RuleEntity_header = 87,
        RuleEntity_name_list = 88,
        RuleEntity_specification = 89,
        RuleEntity_statement = 90,
        RuleEntity_statement_part = 91,
        RuleEntity_tag = 92,
        RuleEnumeration_literal = 93,
        RuleEnumeration_type_definition = 94,
        RuleExit_statement = 95,
        RuleExpression = 96,
        RuleFactor = 97,
        RuleFile_declaration = 98,
        RuleFile_logical_name = 99,
        RuleFile_open_information = 100,
        RuleFile_type_definition = 101,
        RuleFormal_parameter_list = 102,
        RuleFormal_part = 103,
        RuleFree_quantity_declaration = 104,
        RuleGenerate_statement = 105,
        RuleGeneration_scheme = 106,
        RuleGeneric_clause = 107,
        RuleGeneric_list = 108,
        RuleGeneric_map_aspect = 109,
        RuleGroup_constituent = 110,
        RuleGroup_constituent_list = 111,
        RuleGroup_declaration = 112,
        RuleGroup_template_declaration = 113,
        RuleGuarded_signal_specification = 114,
        RuleIdentifier = 115,
        RuleIdentifier_list = 116,
        RuleIf_statement = 117,
        RuleIndex_constraint = 118,
        RuleIndex_specification = 119,
        RuleIndex_subtype_definition = 120,
        RuleInstantiated_unit = 121,
        RuleInstantiation_list = 122,
        RuleInterface_constant_declaration = 123,
        RuleInterface_declaration = 124,
        RuleInterface_element = 125,
        RuleInterface_file_declaration = 126,
        RuleInterface_signal_list = 127,
        RuleInterface_port_list = 128,
        RuleInterface_list = 129,
        RuleInterface_quantity_declaration = 130,
        RuleInterface_port_declaration = 131,
        RuleInterface_signal_declaration = 132,
        RuleInterface_terminal_declaration = 133,
        RuleInterface_variable_declaration = 134,
        RuleIteration_scheme = 135,
        RuleLabel_colon = 136,
        RuleLibrary_clause = 137,
        RuleLibrary_unit = 138,
        RuleLiteral = 139,
        RuleLogical_name = 140,
        RuleLogical_name_list = 141,
        RuleLogical_operator = 142,
        RuleLoop_statement = 143,
        RuleSignal_mode = 144,
        RuleMultiplying_operator = 145,
        RuleName = 146,
        RuleName_part = 147,
        RuleSelected_name = 148,
        RuleSelected_name_part = 149,
        RuleFunction_call_or_indexed_name_part = 150,
        RuleSlice_name_part = 151,
        RuleAttribute_name_part = 152,
        RuleNature_declaration = 153,
        RuleNature_definition = 154,
        RuleNature_element_declaration = 155,
        RuleNext_statement = 156,
        RuleNumeric_literal = 157,
        RuleObject_declaration = 158,
        RuleOpts = 159,
        RulePackage_body = 160,
        RulePackage_body_declarative_item = 161,
        RulePackage_body_declarative_part = 162,
        RulePackage_declaration = 163,
        RulePackage_declarative_item = 164,
        RulePackage_declarative_part = 165,
        RuleParameter_specification = 166,
        RulePhysical_literal = 167,
        RulePhysical_type_definition = 168,
        RulePort_clause = 169,
        RulePort_list = 170,
        RulePort_map_aspect = 171,
        RulePrimary = 172,
        RulePrimary_unit = 173,
        RuleProcedural_declarative_item = 174,
        RuleProcedural_declarative_part = 175,
        RuleProcedural_statement_part = 176,
        RuleProcedure_call = 177,
        RuleProcedure_call_statement = 178,
        RuleProcess_declarative_item = 179,
        RuleProcess_declarative_part = 180,
        RuleProcess_statement = 181,
        RuleProcess_statement_part = 182,
        RuleQualified_expression = 183,
        RuleQuantity_declaration = 184,
        RuleQuantity_list = 185,
        RuleQuantity_specification = 186,
        RuleRange_decl = 187,
        RuleExplicit_range = 188,
        RuleRange_constraint = 189,
        RuleRecord_nature_definition = 190,
        RuleRecord_type_definition = 191,
        RuleRelation = 192,
        RuleRelational_operator = 193,
        RuleReport_statement = 194,
        RuleReturn_statement = 195,
        RuleScalar_nature_definition = 196,
        RuleScalar_type_definition = 197,
        RuleSecondary_unit = 198,
        RuleSecondary_unit_declaration = 199,
        RuleSelected_signal_assignment = 200,
        RuleSelected_waveforms = 201,
        RuleSensitivity_clause = 202,
        RuleSensitivity_list = 203,
        RuleSequence_of_statements = 204,
        RuleSequential_statement = 205,
        RuleShift_expression = 206,
        RuleShift_operator = 207,
        RuleSignal_assignment_statement = 208,
        RuleSignal_declaration = 209,
        RuleSignal_kind = 210,
        RuleSignal_list = 211,
        RuleSignature = 212,
        RuleSimple_expression = 213,
        RuleSimple_simultaneous_statement = 214,
        RuleSimultaneous_alternative = 215,
        RuleSimultaneous_case_statement = 216,
        RuleSimultaneous_if_statement = 217,
        RuleSimultaneous_procedural_statement = 218,
        RuleSimultaneous_statement = 219,
        RuleSimultaneous_statement_part = 220,
        RuleSource_aspect = 221,
        RuleSource_quantity_declaration = 222,
        RuleStep_limit_specification = 223,
        RuleSubnature_declaration = 224,
        RuleSubnature_indication = 225,
        RuleSubprogram_body = 226,
        RuleSubprogram_declaration = 227,
        RuleSubprogram_declarative_item = 228,
        RuleSubprogram_declarative_part = 229,
        RuleSubprogram_kind = 230,
        RuleSubprogram_specification = 231,
        RuleProcedure_specification = 232,
        RuleFunction_specification = 233,
        RuleSubprogram_statement_part = 234,
        RuleSubtype_declaration = 235,
        RuleSubtype_indication = 236,
        RuleSuffix = 237,
        RuleTarget = 238,
        RuleTerm = 239,
        RuleTerminal_aspect = 240,
        RuleTerminal_declaration = 241,
        RuleThrough_aspect = 242,
        RuleTimeout_clause = 243,
        RuleTolerance_aspect = 244,
        RuleType_declaration = 245,
        RuleType_definition = 246,
        RuleUnconstrained_array_definition = 247,
        RuleUnconstrained_nature_definition = 248,
        RuleUse_clause = 249,
        RuleVariable_assignment_statement = 250,
        RuleVariable_declaration = 251,
        RuleWait_statement = 252,
        RuleWaveform = 253,
